...
![기간](https://img.shields.io/badge/2025.01_~_진행중-333?style=for-the-badge)
...
| 수업 스케줄 (주간 뷰) | 수업 개설 |
|:---:|:---:|
| ![수업스케줄](img/user/수업스케줄_관리자앱.png) | ![수업개설](img/수업개설.png) |

| 회원 관리 | 회원 등록 |
|:---:|:---:|
| ![회원선택](img/회원선택.png) | ![회원생성](img/회원생성.png) |

| 통계 (매출/회원/수업) | 오늘의 운동 (리치 에디터) |
|:---:|:---:|
...
| 설정 — 회원권 템플릿 | 설정 — 운영 정책 |
|:---:|:---:|
| ![설정_회원권](img/설정_회원권.png) | ![설정_운영정책](img/설정_운영정책.png) |

### 회원 앱 (PWA)

| 수업 예약 | 수업 예약 (상세) | 예약 완료 |
|:---:|:---:|:---:|
| ![수업예약1](img/user/수업예약1.png) | ![수업예약2](img/user/수업예약2.png) | ![수업예약3](img/user/수업예약3.png) |

| 마이페이지 | 설정 화면 | 만료 회원권 |
|:---:|:---:|:---:|
| ![마이페이지](img/user/마이페이지.png) | ![설정화면](img/user/설정화면.png) | ![만료회원권](img/user/만료회원권.png) |

| 이전 수업 | 예약 불가 (오픈 전) | 휴일 안내 |
|:---:|:---:|:---:|
| ![이전수업](img/user/이전수업.png) | ![예약불가](img/user/예약불가%20페이지(예약오픈%20기간전).png) | ![휴일](img/user/휴일페이지.png) |
...
> 📐 **[인터랙티브 아키텍처 다이어그램 보기 →](architecture.html)**  
